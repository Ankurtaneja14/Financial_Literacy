  ...
  <nav class="sidebar">
    ...
    <div class="sidebar-links">
      ...
      <ul>
        ...
        <li>
          <a href="papertrading.php" title="Payments" class="tooltip">
            ...
            <span class="link hide">Paper Trading</span>
            <span class="tooltip__content">Paper Trading</span>
          </a>
        </li>
        <li>
          <a href="#analytics" title="Analytics" class="tooltip">
            ...
            <span class="link hide">Expense Tracking</span>
            <span class="tooltip__content">Expense Tracking</span>
          </a>
        </li>
        <li>
          <a href="abc.php" title="Products" class="tooltip">
            ...
            <span class="link hide">Budget Calculator</span>
            <span class="tooltip__content">Budget Calculator</span>
          </a>
        </li>
        <li>
          <a href="investment.php" title="Reports" class="tooltip">
            ...
            <span class="link hide">Investment Analysis</span>
            <span class="tooltip__content">Investment Analysis</span>
          </a>
        </li>
    </div>
